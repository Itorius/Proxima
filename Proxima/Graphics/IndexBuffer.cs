...
namespace Proxima.Graphics
{
	public class IndexBuffer<T> : Buffer where T : unmanaged
	{
		...
		public unsafe IndexBuffer(GraphicsDevice graphicsDevice, T[] data)
		{
			...
			var (vkBuffer, vkDeviceMemory) = CreateBuffer(graphicsDevice, bufferSize, VkBufferUsageFlags.TransferDst | VkBufferUsageFlags.IndexBuffer, VkMemoryPropertyFlags.DeviceLocal);
			Buffer = vkBuffer;
